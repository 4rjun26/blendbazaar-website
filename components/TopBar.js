...
import {
  ...
  DrawerContent,
  DrawerCloseButton,
 InputLeftElement,Collapse,Box,Flex,Text,Tag,TagLabel,
  Popover,
  PopoverTrigger,
  PopoverContent,
  PopoverHeader,
...
const { isOpen, onOpen, onClose } = useDisclosure()
  ...
  return (
   ...
   <Drawer placement={'left'} size={'md'} onClose={onClose} isOpen={isOpen}>
    ...
    <h1 className={pacifico.className} style={{"color":"rgb(232,232,232)"}}>BlendBazaar</h1>
...
<Button  onClick={onOpen} color={'white'} bg={'none'} _hover={'none'}>
  ...
  <Avatar border={'1px solid white'} src={"session.user.image"} size='sm' name={'abc'} />
    </Button>
    </Link>
</>
...
{/* <Avatar src={'/avatars/avatar_'+'arpitjain3'+'.png'} size='sm' name={'arpitjain3'} ml={-2} mr={2} /> */}
  ...
  null
    ...
    <Button size={'sm'} mr={'5px'} bg={'rgb(53,53,53)'} _hover={'none'} color={'rgb(242,242,242)'} >Previous</Button>

<Button size={'sm'} bg={'rgb(53,53,53)'} mr={'5px'} _hover={'none'} color={'rgb(242,242,242)'} >Next</Button>
{path=='/feed' ? 
<Menu>
